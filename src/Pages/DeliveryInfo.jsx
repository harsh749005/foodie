...
const DeliveryInfo = () => {
  ...
  return (
    <div className="w-[90%] lg:w-[70%] m-auto flex gap-12 mt-28" >
      <div className='flex flex-col gap-5'>
        ...
        <div className='flex gap-2'>
            <input type="text" name='pincode'className='text-[18px] p-2 border-2 rounded border-slate-200 bg-transparent outline-red-500 pl-5 ' placeholder='pincode'/>
        </div>
        <div>
        ...
        <div className='w-1/2 flex flex-col gap-4 lg:gap-8 '>
        ...
        <Link to='/foodie/payment'>
        <button className=' w-80 text-sm p-2 lg:p-0 lg:h-12 rounded text-white lg:text-xl font-medium cursor-pointer bg-orange-500'>Procceded To Payment</button>
        </Link>
      </div>
      </div>
