...
const Footer = () => {
  return (
    <div className='mt-10 flex items-start justify-between bg-zinc-900 h-max p-14'>
      <div className='flex flex-col gap-5'>
        <div>
        <img src={assets.logo} alt="" />
        </div>
        <p className='text-white w-[650px]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit tenetur maxime sapiente ad libero, dolorem vel necessitatibus doloremque at amet. Soluta provident beatae aperiam deserunt vero quibusdam aspernatur magni ea.
</p>
        <div className='flex items-center gap-5'>
            <a className='cursor-pointer' href=''><img src={assets.facebook_icon} alt="" /></a>
            <a className='cursor-pointer' href=''><img src={assets.twitter_icon} alt="" /></a>
            <a className='cursor-pointer' href=''><img src={assets.linkedin_icon} alt="" /></a>
        </div>
      </div>
      <div className='flex flex-col gap-5'>
