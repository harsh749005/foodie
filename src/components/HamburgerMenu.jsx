...
const HamburgerMenu = ({closeMenu}) => {
  return (
    <div className='absolute sm:left-6 md:left-[50%] md:top-[50%] md:translate-x-[-50%] md:translate-y-[-50%] bg-white z-10  w-96 p-5 lg:hidden h-max  items-center flex flex-col gap-5  rounded-lg border-2  '>
